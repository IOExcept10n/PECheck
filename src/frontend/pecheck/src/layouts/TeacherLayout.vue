...
const currentPageTitle = computed(() => {
  ...
  if (routeName.includes('attendance')) return 'Посещаемость'
  if (routeName.includes('student')) return 'Студенты'
    ...
    <aside class="sidebar" :class="{ 'sidebar-collapsed': !sidebarOpen, 'sidebar-mobile': isMobile && sidebarOpen }">
      ...
      <div class="sidebar-content">
        <nav class="sidebar-nav">
          <RouterLink to="/teacher" class="nav-item" exact-active-class="nav-item-active">
            <i class="material-icons">home</i>
            <span v-if="sidebarOpen">Главная</span>
          </RouterLink>
          <RouterLink to="/teacher/sections" class="nav-item" active-class="nav-item-active">
            <i class="material-icons">fitness_center</i>
            <span v-if="sidebarOpen">Мои секции</span>
          </RouterLink>
          <RouterLink to="/teacher/attendance" class="nav-item" active-class="nav-item-active">
            <i class="material-icons">how_to_reg</i>
            <span v-if="sidebarOpen">Посещаемость</span>
          </RouterLink>
          <RouterLink to="/teacher/students" class="nav-item" active-class="nav-item-active">
            <i class="material-icons">people</i>
            <span v-if="sidebarOpen">Студенты</span>
          </RouterLink>
        </nav>
      </div>
    ...
    <main class="main-content" :class="{ 'main-content-expanded': !sidebarOpen || (isMobile && !sidebarOpen) }">
      <header class="main-header">
        ...
        <div class="header-actions">
          ...
          <div class="profile-image" @click="router.push('/teacher/profile')" title="Профиль">
      ...
      <div class="mobile-nav" v-if="isMobile">
        <RouterLink to="/teacher" class="mobile-nav-item" exact-active-class="mobile-nav-active">
          <i class="material-icons">home</i>
          <span>Главная</span>
        </RouterLink>
        <RouterLink to="/teacher/sections" class="mobile-nav-item" active-class="mobile-nav-active">
          <i class="material-icons">fitness_center</i>
          <span>Секции</span>
        </RouterLink>
        <RouterLink to="/teacher/attendance" class="mobile-nav-item" active-class="mobile-nav-active">
          <i class="material-icons">how_to_reg</i>
