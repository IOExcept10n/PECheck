...
const currentPageTitle = computed(() => {
  ...
  if (routeName.includes('normative')) return 'Нормативы'
...
<template>
  <div class="layout-container" :class="{ 'dark-mode': isDarkMode }">
    ...
    <aside class="sidebar" :class="{ 'sidebar-collapsed': !sidebarOpen, 'sidebar-mobile': isMobile && sidebarOpen }">
      ...
      <div class="sidebar-content">
        <nav class="sidebar-nav">
          <RouterLink to="/student" class="nav-item" exact-active-class="nav-item-active">
            <i class="material-icons">home</i>
            <span v-if="sidebarOpen">Главная</span>
          </RouterLink>
          <RouterLink to="/student/sections" class="nav-item" active-class="nav-item-active">
            <i class="material-icons">fitness_center</i>
            <span v-if="sidebarOpen">Секции</span>
          </RouterLink>
          <RouterLink to="/student/normatives" class="nav-item" active-class="nav-item-active">
            <i class="material-icons">assessment</i>
            <span v-if="sidebarOpen">Нормативы</span>
          </RouterLink>
        </nav>
      </div>
    ...
    <main class="main-content" :class="{ 'main-content-expanded': !sidebarOpen || (isMobile && !sidebarOpen) }">
      <header class="main-header">
        ...
        <div class="header-actions">
          <button class="action-btn qr-btn" @click="toggleQrModal" title="Показать QR-код">
          ...
          <div class="profile-image" @click="router.push('/student/profile')" title="Профиль">
      ...
      <div class="mobile-nav" v-if="isMobile">
        <RouterLink to="/student" class="mobile-nav-item" exact-active-class="mobile-nav-active">
          <i class="material-icons">home</i>
          <span>Главная</span>
        </RouterLink>
        <RouterLink to="/student/sections" class="mobile-nav-item" active-class="mobile-nav-active">
          <i class="material-icons">fitness_center</i>
          <span>Секции</span>
        </RouterLink>
        <RouterLink to="/student/normatives" class="mobile-nav-item" active-class="mobile-nav-active">
          <i class="material-icons">assessment</i>
          <span>Нормативы</span>
        </RouterLink>
      </div>
    ...
    <!-- QR Code Modal -->
    <div v-if="showQrModal" class="modal-overlay" @click="toggleQrModal">
      <div class="modal-content" @click.stop>
        <div class="modal-header">
          <h3>QR-код посещаемости</h3>
          <button class="close-button" @click="toggleQrModal">
            <i class="material-icons">close</i>
          </button>
        </div>
